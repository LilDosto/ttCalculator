...
namespace DotNetMatrix
{
	...
	/// arrays of decimal precision decimaling point numbers.  Various "gets" and
	...
	/// <P><PRE>
	/// decimal[][] vals = {{1.,2.,3},{4.,5.,6.},{7.,8.,10.}};
	...
	public class GeneralMatrix : System.ICloneable, System.Runtime.Serialization.ISerializable, System.IDisposable
	{
		...
		/// <param name="A">   Two-dimensional array of decimals.
		/// </param>
		...
		/// <param name="vals">One-dimensional array of decimals, packed by columns (ala Fortran).
		/// </param>
		/// <param name="m">   Number of rows.
		/// </param>
		...
		/// </returns>
		virtual public decimal[][] ArrayCopy
		{
			get
			{
		...
		/// </returns>
		virtual public decimal[] ColumnPackedCopy
		{
			get
			{
		...
		/// </returns>
		virtual public decimal[] RowPackedCopy
		{
			get
			{
				decimal[] vals = new decimal[m * n];
		...
		public static GeneralMatrix Create(decimal[][] A)
		{
			int m = A.Length;
			int n = A[0].Length;
